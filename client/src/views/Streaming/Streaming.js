			...
			<div className="animated fadeIn">
				<Row>
					<Col xs="12" sm="12" lg="6">
						{/* <div style="width:100%;height:0px;position:relative;padding-bottom:75.000%;"><iframe src="https://streamable.com/s/gusa0/gqjvxm" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div> */}
						<Player src="https://cdn-b-east.streamable.com/video/mp4/gusa0.mp4?token=eABKSw4A6JSAqXvCL1-Jtg&expires=1566453360" autoPlay/>
					</Col>
					<Col xs="12" sm="12" lg="6">
						{/* <div style="width:100%;height:0px;position:relative;padding-bottom:75.000%;"><iframe src="https://streamable.com/s/gusa0/gqjvxm" frameborder="0" width="100%" height="100%" allowfullscreen style="width:100%;height:100%;position:absolute;left:0px;top:0px;overflow:hidden;"></iframe></div> */}
						<Player src="https://cdn-b-east.streamable.com/video/mp4/gusa0.mp4?token=eABKSw4A6JSAqXvCL1-Jtg&expires=1566453360" autoPlay />
